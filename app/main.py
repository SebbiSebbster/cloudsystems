...
redis_server = "10.2.1.8"
redis_db = 1
redis_channels = ["found"]
r_server = redis.Redis(host=redis_server, port=6379, charset="utf-8", decode_responses=True)
...
if __name__ == '__main__':
    ...
    generation_size = int(os.getenv('GENERATION_SIZE', -1))
